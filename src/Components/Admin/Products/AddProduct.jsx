          ...
          <div className='addProductInputContainer'>
            <div>
              ...
              <div className='addProductFormLeft'>
                <label className='addProductInputLabel'>Product</label>
                <br />
                <input
                  required
                  type='text'
                ...
                <label className='addProductInputLabel'>Price</label>
                <br />
                <input
                  required
                  type='number'
                  ...
                  onChange={(e) => {
                    ...
                    setRating(Math.floor(Math.random() * 5) + 2);
                    setReview(Math.floor(Math.random() * 25));
                  }}
                />
                <br />
                <br />

                <label className='addProductInputLabel'>Category</label>
                <br />
                <input
                  required
                  type='text'
                ...
                <label className='addProductInputLabel'>Brand</label>
                <br />
                <input
                  required
                  type='text'
                ...
                {departments && (
                  <>
                    <label className='addProductInputLabel'>Department</label>
                    <br />
                    <select
                      name='department'
                      id='department'
              ...
              <div className='addProductFormRight'>
                <label className='addProductInputLabel'>Description</label>
                <br />
                <textarea
                  type='text'
                ...
                <label className='addProductInputLabel'>Stock</label>
                <br />
                <input
                  required
                  type='number'
                ...
                <label className='addProductInputLabel'>Image</label>
                <img
                  src={image}
                  style={{
                    height: "8.5rem",
